<?php 
	$use = mysqli_fetch_object(getAdminbyUsername($_SESSION['lms_admin_'],$conn));

?>
<div class="sidebar lms-white" data-color="white" data-active-color="danger">
	      <!--
	    ...
	    -->
	      ...
	      <div class="sidebar-wrapper ps-container ps-theme-default">
	        <ul class="nav">
	          ...
	          <li>
	            <a href="#" data-remote="admin_pages/changepass.php" class="poop" title="Change Password">
	              <i class="nc-icon nc-spaceship"></i>
	              <p>Change Password</p>
	            </a>
	          </li>
	         ...
	         <!--  <li>
	          ...
	          <li class="acadsettings">
	            <a href="?d=acadsettings">
	      ...
	      <?php } ?>
	          ...
	          <!-- <li class="active-pro">
	            <a href="#">
	              <i class="nc-icon nc-single-02"></i>
	              <p>Welcome <?=$use->adm_name?>!</p>
	            </a>
	          </li> -->
	        </ul>
	      <div class="ps-scrollbar-x-rail" style="width: 260px; left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 258px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
	    </div>